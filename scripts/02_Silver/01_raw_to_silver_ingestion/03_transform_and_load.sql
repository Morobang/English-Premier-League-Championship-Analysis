...
SELECT
    ...
    TRY_CONVERT(INT, [FTH_Goals]) AS FullTimeHomeGoals,
    TRY_CONVERT(INT, [FTA_Goals]) AS FullTimeAwayGoals,
    TRY_CONVERT(INT, TRY_CONVERT(DECIMAL(5,1), [HTH_Goals])) AS HalfTimeHomeGoals,
    TRY_CONVERT(INT, TRY_CONVERT(DECIMAL(5,1), [HTA_Goals])) AS HalfTimeAwayGoals,
    TRY_CONVERT(INT, TRY_CONVERT(DECIMAL(5,1), [H_Shots])) AS HomeShots,
    TRY_CONVERT(INT, TRY_CONVERT(DECIMAL(5,1), [A_Shots])) AS AwayShots,
    TRY_CONVERT(INT, TRY_CONVERT(DECIMAL(5,1), [H_SOT])) AS HomeShotsOnTarget,
    TRY_CONVERT(INT, TRY_CONVERT(DECIMAL(5,1), [A_SOT])) AS AwayShotsOnTarget,
    TRY_CONVERT(INT, TRY_CONVERT(DECIMAL(5,1), [H_Fouls])) AS HomeFouls,
    TRY_CONVERT(INT, TRY_CONVERT(DECIMAL(5,1), [A_Fouls])) AS AwayFouls,
    TRY_CONVERT(INT, TRY_CONVERT(DECIMAL(5,1), [H_Corners])) AS HomeCorners,
    TRY_CONVERT(INT, TRY_CONVERT(DECIMAL(5,1), [A_Corners])) AS AwayCorners,
    TRY_CONVERT(INT, TRY_CONVERT(DECIMAL(5,1), [H_Yellow])) AS HomeYellowCards,
    TRY_CONVERT(INT, TRY_CONVERT(DECIMAL(5,1), [A_Yellow])) AS AwayYellowCards,
    TRY_CONVERT(INT, TRY_CONVERT(DECIMAL(5,1), [H_Red])) AS HomeRedCards,
    TRY_CONVERT(INT, TRY_CONVERT(DECIMAL(5,1), [A_Red])) AS AwayRedCards,
...
WHERE
    ...
    AND TRIM(HomeTeam) <> ''
    AND TRIM(AwayTeam) <> ''
    AND TRY_CONVERT(INT, [FTH_Goals]) IS NOT NULL
    AND TRY_CONVERT(INT, [FTA_Goals]) IS NOT NULL
